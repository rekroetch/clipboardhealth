...
describe("deterministicPartitionKey", () => {
  ...
  it("Returns a random hex code when given an empty object", () => {
    const trivialKey = deterministicPartitionKey({});
    expect(trivialKey).not.toBe("0");
    expect(trivialKey).toHaveLength(128);
  });
  it("Returns a hex code when given an object without a partitionKey", () => {
  ...
  it("Returns hex code when partitionKey has length > 256", () => {
